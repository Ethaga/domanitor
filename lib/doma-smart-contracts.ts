...
// Doma Protocol Smart Contract Addresses on Doma Network Testnet
export const DOMA_SMART_CONTRACTS = {
  ...
  OWNERSHIP_TOKEN: '0xabcd35Cc6634C0532925a3b8D4C9db96C4b5Da5e'
}

// Doma testnet chain configuration
export const DOMA_CHAIN_CONFIG = {
  chainId: '0x17cc4', // Doma Network Testnet (97476)
  chainName: 'Doma Network Testnet',
  nativeCurrency: {
    name: 'Ethereum',
    symbol: 'ETH',
    decimals: 18
